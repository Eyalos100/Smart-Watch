...
static uint8_t g_lcd_backlight = 0x08;
...
{
    LCD_WriteRaw(data | 0x04 | g_lcd_backlight);
    DrvSYS_Delay(200);
    LCD_WriteRaw((data & ~0x04) | g_lcd_backlight);
    DrvSYS_Delay(200);
}
...
{
    uint8_t data = (nibble & 0xF0) | (rs ? 0x01 : 0x00) | g_lcd_backlight;
    LCD_WriteRaw(data);
    LCD_Pulse(data);
}
