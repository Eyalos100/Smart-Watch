...
#line 35 "menu.c"
#line 1 "LCM1602_I2C.h"



#line 5 "LCM1602_I2C.h"
...
int fall_chk(){
    ...
    if (fall_phase == 0) {
        ...
        } else if (magnitude > (0.8) && magnitude < (1.2)) { 
...
void home(uint8_t hour, uint8_t min, uint8_t sec){ 
	char Menu[16];
...
void InitTIMER0(void)
{
	...
	((TIMER_T *) ((( uint32_t)0x40000000) + 0x10000))->TCMPR = 1000;		
...
int32_t main (void)
{
	...
	*((volatile uint32_t *)(((( uint32_t)0x50000000) + 0x00000) + 0x100)) = 0x00;; 
	...
	DrvADC_Open(ADC_SINGLE_END, ADC_SINGLE_CYCLE_OP, 0xF0, INTERNAL_HCLK, 1);
	Init_GPIO();
  ...
  DrvGPIO_Open(E_GPB, 9, E_IO_INPUT); 
	...
	while(1){
		...
		Vx = ((ADC_T *) ((( uint32_t)0x40000000) + 0xE0000))->ADDR[5].RSLT & 0xFFF;
		Vy = ((ADC_T *) ((( uint32_t)0x40000000) + 0xE0000))->ADDR[4].RSLT & 0xFFF;
		heart_value = ((ADC_T *) ((( uint32_t)0x40000000) + 0xE0000))->ADDR[6].RSLT & 0xFFF;
		temp_value=((ADC_T *) ((( uint32_t)0x40000000) + 0xE0000))->ADDR[7].RSLT & 0xFFF;
		temp_value=temp_value*4.7;
		temp_value=temp_value/4096;
		temp_value-=0.4;
		temp_value=temp_value*51;
		SW = DrvGPIO_GetBit(E_GPB,9);
