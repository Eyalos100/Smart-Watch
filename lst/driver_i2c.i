...
void I2C_WriteRawByte(uint8_t addr7, uint8_t data)
{
    ...
    I2C_Ctrl(1, 0, 1, 0);
    while (((I2C_T *) ((( uint32_t)0x40000000) + 0x20000))->I2CON . SI == 0);

    
    ((I2C_T *) ((( uint32_t)0x40000000) + 0x20000))->I2CDAT = (addr7 << 1);
    I2C_Ctrl(0, 0, 1, 0);
    while (((I2C_T *) ((( uint32_t)0x40000000) + 0x20000))->I2CON . SI == 0);
    ...
    I2C_Ctrl(0, 1, 1, 0);
    while (((I2C_T *) ((( uint32_t)0x40000000) + 0x20000))->I2CON . STO);
}
...
void I2C_Write(uint8_t INDEX,uint8_t DATA)
{
	...
	((I2C_T *) ((( uint32_t)0x40000000) + 0x20000))->I2CDAT = 0xD0;
  I2C_Ctrl(0, 0, 1, 0);   
  while(((I2C_T *) ((( uint32_t)0x40000000) + 0x20000))->I2CON . SI==0);	
...
uint8_t I2C_Read(uint8_t INDEX)
{
  ...
  I2C_Ctrl( 1, 0, 1, 0);	
	...
	((I2C_T *) ((( uint32_t)0x40000000) + 0x20000))->I2CDAT = (0xD0+1);
  I2C_Ctrl(0, 0, 1, 0);	  
  while(((I2C_T *) ((( uint32_t)0x40000000) + 0x20000))->I2CON . SI==0);	
